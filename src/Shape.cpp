...
struct ShapeSubmitKnobSmall : SvgKnob {
    ShapeSubmitKnobSmall() {
        minAngle = -0.83 * M_PI;
        maxAngle = 0.83 * M_PI;
...
struct ShapeWidget : ModuleWidget {
    ShapeWidget(Shape* module) {
        ...
        addParam(createParamCentered<ShapeSubmitKnobSmall>(mm2px(Vec(11.76f, 33.62f)), module, Shape::HIGH_PASS_PARAM));
        addParam(createParamCentered<ShapeSubmitKnobSmall>(mm2px(Vec(29.33f, 33.70f)), module, Shape::LOW_SHELF_PARAM));
        addParam(createParamCentered<ShapeSubmitKnobSmall>(mm2px(Vec(11.76f, 55.68f)), module, Shape::LOW_MID_PARAM));
        addParam(createParamCentered<ShapeSubmitKnobSmall>(mm2px(Vec(29.33f, 55.76f)), module, Shape::HIGH_MID_PARAM));
        addParam(createParamCentered<ShapeSubmitKnobSmall>(mm2px(Vec(11.76f, 77.91f)), module, Shape::HIGH_SHELF_PARAM));
        addParam(createParamCentered<ShapeSubmitKnobSmall>(mm2px(Vec(29.33f, 77.99f)), module, Shape::LOW_PASS_PARAM));
